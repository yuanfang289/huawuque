        ...
        <ul>
          <li v-for="(item,index) in data">
            <a :href="'/user/userDetail?userId='+item.id">
              <div class="listener">
                <img class="listener-img" :src="''+item.headImageUrl+'?imageMogr2/auto-orient/thumbnail/!110x110r/gravity/Center/crop/110x110/format/'+isWebp" onerror="javascript:this.src='https://assets.urwork.cn/image/headImg.png';"/>
