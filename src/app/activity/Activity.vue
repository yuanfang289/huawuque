              ...
              <template slot-scope="{item}">
                <a :href="'/activity/h5Detail?id='+item.id">
                  <li class="li">
                    ...
                    <div class="img">
                      <img :src="'https://image.urwork.cn/'+item.image3+'?imageMogr2/thumbnail/!220x220r/gravity/Center/crop/220x220/format/'+isWebp" onerror="javascript:this.src='https://assets.urwork.cn/image/headImg.png';">
                    </div>
                  </li>
                </a>
              </template>
