          ...
          <div class="company-info">
            ...
            <div class="item-img">
              <div v-if="personalUp.headImage" class="img">
                <img :src="personalUp.headImage+'?imageMogr2/auto-orient/thumbnail/!196x196r/gravity/Center/crop/196x196/format/'+isWebp" onerror="javascript:this.src='https://assets.urwork.cn/image/headImg.png';">
              </div>
...
<script>
  ...
  import Notice from 'app/member/modules/Notice';//测试
  import AdBanner from 'app/member/modules/AdBanner';
