            ...
            <div v-if="companyUp != -1" class="company-info">
              ...
              <div class="item-img">
                <div class="img" v-if="companyUp.companyLogo">
                  <img :src="companyUp.companyLogo+'?imageMogr2/auto-orient/thumbnail/!196x196r/gravity/Center/crop/196x196/format/'+isWebp" onerror="javascript:this.src='https://assets.urwork.cn/image/v3/member/default-company.jpg';">
                </div>
                ...
                <div class="top-three">
                  <ul>
                    <a v-for="item in companyUp.userContributePointsList" :href="'/user/userDetail?userId='+item.userId">
                      <li>
                        <img :src="item.headImage+'?imageMogr2/auto-orient/thumbnail/!120x120r/gravity/Center/crop/120x120/format/'+isWebp" onerror="javascript:this.src='https://assets.urwork.cn/image/headImg.png';">
              ...
              <div class="coupon-content">
                <div class="two">
                  <div class="bag" v-for="item in ongoingCompanyRights" @click="linkto(item)">
                    <div class="img">
                      <img :src="item.image+'?imageMogr2/auto-orient/thumbnail/!320x260r/gravity/Center/crop/320x260/format/'+isWebp">
                    </div>
