<template>
  <page-wrap class="page-user-center">
    ...
    <page-main :show="show">
      <div class="ticket">
        <img src="https://assets.urwork.cn/image/member/yanzhao-zt.png">
        <div class="explain">
          <h3><span class="mid_boder"></span>权益说明<span class="mid_boder"></span></h3>
          <ul>
            <li>1、价值49元的“10片装 蒸汽热敷眼罩”免单券，严选新用户可直接使用，严选老用户订单需满一定金额后使用；</li>
            <li>2、复制优惠码到剪切板，打开“网易严选App” → 右下角“个人”页面 → 找到“优惠券”功能 → 粘贴优惠码 → 点击“兑换”，即可获得优惠券；</li>
            <li>3、网易严选大陆地区，全场满88包邮；</li>
            <li>4、1000张优惠券，每人限领1张，先到先得！</li>
          </ul>
        </div>
        <div class="kong"></div>
        <div class="cont">
