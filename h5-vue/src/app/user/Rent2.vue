<template>
  <page-wrap class="page-user-center">
    ...
    <page-main :show="show">
      <div class="ticket">
        <div class="banner">
          <img src="https://assets.urwork.cn/image/member/rent2.png">
          <div class="contbox">
            <div class="cont" @click="gotoUrl('https://h5.youzan.com/v2/promocardfetch/15krpf0zs?redirect_count=1')">
              <p class="rights-code">领取优惠券
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="explain-box">
          <div class="explain">
            ...
            <ul>
              ...
              <li>
                <h5>活动内容</h5>
                1. 即时用车85折最高减10元优惠券１张，自领取后７日内有效；<br>2. 接送机85折最高减30元优惠券１张，自领取后60天内有效；
              </li>
              <li>
                <h5>优惠券领取及查看方式</h5>
               输入手机号-领取优惠券-下载并登陆App-我的钱包-优惠券中查看
              </li>
              <li>
                <h5>使用限制</h5>
