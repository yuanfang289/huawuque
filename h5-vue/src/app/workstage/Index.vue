            ...
            <template slot-scope="{item}">
              <!--<template>-->
                <a :href="item.stageStatus != 0 ? 'javascript:void(0);':'/workstage/detail?id='+item.id">
                  <li>
                    <div class="left">
                      <img :src="item.workstageImage+'?imageMogr2/auto-orient/thumbnail/!335x214r/gravity/Center/crop/335x214/format/'+isWebp+'/quality/90'" onerror="src='https://image.urwork.cn/default/rentstation.png?imageMogr2/auto-orient/thumbnail/!210x280r/gravity/Center/crop/210x280'">
